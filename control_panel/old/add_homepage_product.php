...
<h2>Add Homepage Product</h2>
 ...
 <?php
   ...
   
   {
    ...
    <br/><br/><br/>
    <form method="post"   action="adding_homepage_product.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm()">
    ...
    <center><h3>Current Homepage Products</h3></center>
...
<table class="data display datatable" id="example" style="width:850px;">
		...
		<tbody>
						...
						$query=mysql_query("SELECT * FROM home_page_product ORDER BY product_id DESC");
			...
			<tr class="odd gradeX">
                ...
                <td class="center">
					 <img src="<?php echo '../admin/'.$pic_url; ?>" style="width:150px;" >
                 ...
                 <a href="remove_home_product.php?product_id=<?php echo $h_product_id; ?>"  onClick="return confarmation()">Remove</a>
