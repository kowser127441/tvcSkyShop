...
function changecategory2()
		{
			...
			xmlhttp.open("GET","sub_product_dis.php?sub_category_id=" + sub_category_id + "&category_id="+ category_id ,true);
			xmlhttp.send();	
...
<h2>Remove Discount</h2>
 ...
 <?php
   ...
   
   {
    ...
    <br/><br/><br/>
    <form method="post"   action="removing_discount.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm()">
    ...
    <table width="500" border="0">
        ...
        <td><span id="bodyspan_2"> </span></td>
         ...
         <tr>
          <td></td>
            <td>
            <input type="submit" value="Remove"  style="margin-left:100px; height:30px; width:80px; font-size:15px;">
            </td>
          </tr>
