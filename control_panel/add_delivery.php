...
<h2>Add Delivery</h2>
 ...
 <?php
   ...
   
   {
    ...
    <br/><br/><br/>
    <form method="post" action="adding_delivery.php" style="margin-left:20px"  name="myForm" onsubmit="return validateForm1()">
   
    
    
    <textarea  cols="100" name="delivery" id="area3" style="width:700px; height:300px;"><?php echo $delivery; ?></textarea>
